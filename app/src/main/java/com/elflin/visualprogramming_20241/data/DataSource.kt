package com.elflin.visualprogramming_20241.data

import android.annotation.SuppressLint
import com.elflin.visualprogramming_20241.R
    ...
    public fun loadMovie(): List<Movie> {
        return listOf<Movie>(
            ...
            Movie(
                ...
                R.drawable.image_2.toString(),
                SimpleDateFormat("yyyy-MM-dd").parse("1984-11-16")!!,
                "Stop Making Sense",
                8.2f,
                208
            ),
            Movie(
                ...
                R.drawable.image_3.toString(),
                SimpleDateFormat("yyyy-MM-dd").parse("2022-11-23")!!,
                "Saint Omer",
                6.3f,
                99
            ),
            Movie(
                ...
                R.drawable.image_4.toString(),
                SimpleDateFormat("yyyy-MM-dd").parse("2021-01-07")!!,
